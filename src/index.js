  ...
  if (msg.chat.type !== 'private') {
      try {
          ...
          if (!allowedStatuses.includes(adminMember.status)) {
            ...
            const phrases = [
                "Так, стопэ. Админа не вижу. Благотворительности не будет, я сваливаю!",
                "Опа, куда это меня занесло? Бати рядом нет, так что я сваливаю!",
                "Вы че думали, украли бота? Я не работаю в беспризорных приютах. Я сваливаю!",
                "⚠️ ERROR: ADMIN NOT FOUND. Включаю протокол самоуважения. Я сваливаю!",
                "Не, ну вы видели? Затащили без спроса. Ну вас нафиг, я ухожу!"
            ];
