...
console.log("Советник готов к работе.");
  ...
  if (msg.chat.type !== 'private') {
      try {
          ...
          if (!allowedStatuses.includes(adminMember.status)) {
            ...
            const phrases = [
                "Так, стопэ. Админа не вижу. Ухожу!",
                "Админа рядом нет, так что я ухожу!",
                "Вы что думали, украли бота? Я не работаю в неизхвестных чатах!",
                "⚠️ ERROR: ADMIN NOT FOUND. Включаю протокол самоуважения. Я ухожу!",
                "Нет, ну вы видели? Затащили меня непонятно куда, непонятно зачем, без спроса. Ну вас нафиг, я ухожу!"
            ];
